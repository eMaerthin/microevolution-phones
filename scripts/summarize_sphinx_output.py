...
print('Total time: {}s.\nTotal time covered by meaningful phonemes: {}s.\nTotal number of phonemes: {}.\n'.format(
    total_recording_time, 
    df_results.phones_duration_total.sum(), 
    df_results.phones_histogram.sum()))
print(df_results[['phones_histogram_freq']])#.sort_values(by='phones', ascending=False))#.head(n=20))
